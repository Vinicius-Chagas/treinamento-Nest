export const changePasswordSuccessTemplate = (urlFront: string) => {
  return `
  <div style='background: #F1F2F7; border-radius: 5px; padding: 25px; max-width: 720px; margin: 0 auto;'>
  <center style="margin-bottom: 10px;">
    <img
        src="https://storage.googleapis.com/erp-financeiro-dev.appspot.com/Logo.png"><br>
  </center>
  <center>
    ...
    <p style='color: #7C7C7C; font-size: 14px; font-family: Arial, Helvetica, sans-serif; padding:8px; margin:8px;'>Agora está tudo seguro, é só abrir o sistema.
    </p>
    <p>
    ...
    <p>
      <center style='margin-top: 30px;''><a href="${urlFront}"
        style='width:250px; height: 50px; background: #32C6F4; border-radius: 6px; color: #000000; text-decoration: none; font-family: Arial; padding: 10px 20px;'>Acessar Sistema</a></center>
      </p>
    </div>
  </center>
</div>
